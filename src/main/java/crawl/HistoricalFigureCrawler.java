...
public class HistoricalFigureCrawler {
    private final String fileData = "data/HistoricalFigure.json";
    private static int qty = 0;
    private String source;

    public HistoricalFigureCrawler(String source) {
        this.source = source;
    }
...
//                        System.out.println(info);
        ...
        JsonHandler.writeJsonFile(arr, "data/HistoricalFigure.json");
    }
